...
const useServiceWorker = ({ vapidPublicKey }: { vapidPublicKey?: string }) => {
  ...
  // Initialize notificationsEnabled based on userSubscription
  ...
  useEffect(() => {
    // Update notificationsEnabled if userSubscription changes
    setNotificationsEnabled(!!userSubscription);
  }, [userSubscription]);
